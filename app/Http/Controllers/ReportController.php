...
class ReportController
{
     ...
     *      @OA\Parameter(name="from",description="From Date (YYYY-MM-DD)",required=true,in="path", @OA\Schema(type="String")),
     *      @OA\Parameter(name="to",description="To Date ((YYYY-MM-DD))",required=true,in="path", @OA\Schema(type="String")),
