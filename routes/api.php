...
Route::group(['middleware' => 'ip.whitelist'], function () {
    Route::group(['prefix' => 'v1'], function () {
        Route::get('/partners/{partner}/partner-order-count', [OrderController::class, 'getOrderCount']);
        ...
        Route::put('partners/{partner_id}/orders/{order_id}/delivery', [OrderController::class, 'updateDeliveryInfo']);
        Route::get('partners/{partner_id}/order-by-partner-wise-order-id/{partner_wise_order_id}', [OrderController::class, 'getOrderInfoByPartnerWiseOrderId']);
        ...
        Route::get('partner-wise-order-ids', [OrderController::class, 'getPartnerWiseOrderIds']);
    });
});
